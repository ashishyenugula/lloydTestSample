package com.ashish.lloydtest.interactors.auth
...
import com.ashish.lloydtest.datasource.cache.AuthTokenDaoTest
import com.ashish.lloydtest.datasource.datastore.AppDataStoreManagerTest
import com.ashish.lloydtest.datasource.network.auth.RegisterResponses
...
class RegisterTest {
    ...
    private lateinit var accountDao: AccountDaoTest
    private lateinit var authTokenDao: AuthTokenDaoTest
    private lateinit var dataStore: AppDataStoreManagerTest
    ...
    fun setup() {
        ...
        accountDao = AccountDaoTest(appDatabase)
        authTokenDao = AuthTokenDaoTest(appDatabase)
        dataStore = AppDataStoreManagerTest()
