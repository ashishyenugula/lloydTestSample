package com.ashish.lloydtest.datasource.network.account
...
object AccountResponses {
    ...
    val updateAccountFail_Random = "{ \"random_response\": \"Error\", \"error_message\": \"SOME RANDOM ERROR !!\" }"
    ...
    val updatePasswordFail_random = "{ \"random_response\": \"Error\", \"error_message\": \"SOME RANDOM ERROR \" }"
